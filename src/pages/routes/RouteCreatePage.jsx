  ...
  return (
    <div className="py-4 px-lg-3">
      <div className="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
          <h4 className="fw-bold text-dark mb-0">Nouveau trajet</h4>
          <small className="text-muted">Créer un nouveau trajet de transport</small>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="bg-white rounded-3 shadow-sm p-4 mb-3">
          ...
          <textarea
            ...
            placeholder="Notes ou observations sur ce trajet..."
          />

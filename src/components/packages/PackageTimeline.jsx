...
const typeColors = { creation: 'primary', validation: 'info', transport: 'info', arrival: 'success', livraison: 'success', annulation: 'danger', modification: 'secondary' };

export default function PackageTimeline({ history, loading }) {
  ...
  return (
    <div className="bg-white rounded-3 shadow-sm p-4">
      <h6 className="fw-semibold mb-3 d-flex align-items-center gap-2"><Clock size={16} className="text-muted" /> Suivi du colis</h6>

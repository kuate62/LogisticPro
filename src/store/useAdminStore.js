...
const useAdminStore = create((set) => ({
  ...
  fetchEnterprises: async () => {
    ...
    try {
      const enterprises = await mockAdminService.getEnterprises();
  ...
  fetchEnterprise: async (id) => {
    set({ loading: true, error: null });
    try {
      const selectedEnterprise = await mockAdminService.getEnterprise(id);
  ...
  createEnterprise: async (data) => {
    set({ loading: true, error: null });
    try {
      const enterprise = await mockAdminService.createEnterprise(data);
  ...
  updateEnterprise: async (id, data) => {
    set({ loading: true, error: null });
    try {
      const enterprise = await mockAdminService.updateEnterprise(id, data);
      set((s) => ({
  ...
  updateEnterpriseStatus: async (id, status) => {
    set({ loading: true, error: null });
    try {
      const enterprise = await mockAdminService.updateEnterpriseStatus(id, status);
      set((s) => ({
        enterprises: s.enterprises.map((e) => (e.id === id ? enterprise : e)),
        selectedEnterprise: s.selectedEnterprise?.id === id ? enterprise : s.selectedEnterprise,
        loading: false,
  ...
  fetchPlans: async () => {
    set({ loading: true, error: null });
    try {
      const plans = await mockAdminService.getPlans();
  ...
  createPlan: async (data) => {
    set({ loading: true, error: null });
    try {
      const plan = await mockAdminService.createPlan(data);
  ...
  updatePlan: async (id, data) => {
    set({ loading: true, error: null });
    try {
      const plan = await mockAdminService.updatePlan(id, data);
  ...
  deletePlan: async (id) => {
    set({ loading: true, error: null });
    try {
      await mockAdminService.deletePlan(id);
  ...
  fetchSubscriptions: async () => {
    set({ loading: true, error: null });
    try {
      const subscriptions = await mockAdminService.getSubscriptions();
  ...
  updateSubscription: async (id, data) => {
    set({ loading: true, error: null });
    try {
      const subscription = await mockAdminService.updateSubscription(id, data);
  ...
  fetchRequests: async () => {
    set({ loading: true, error: null });
    try {
      const requests = await mockAdminService.getRequests();
  ...
  reviewRequest: async (id, data) => {
    set({ loading: true, error: null });
    try {
      const request = await mockAdminService.reviewRequest(id, data);
  ...
  fetchPlatformUsers: async () => {
    set({ loading: true, error: null });
    try {
      const platformUsers = await mockAdminService.getPlatformUsers();
  ...
  fetchManagers: async () => {
    set({ loading: true, error: null });
    try {
      const managers = await mockAdminService.getManagers();
  ...
  fetchNotifications: async () => {
    set({ loading: true, error: null });
    try {
      const notifications = await mockAdminService.getNotifications();
  ...
  markNotificationRead: async (id) => {
    try {
      await mockAdminService.markNotificationRead(id);
      set((s) => ({
  ...
  markAllNotificationsRead: async () => {
    try {
      await mockAdminService.markAllNotificationsRead();
      set((s) => ({
